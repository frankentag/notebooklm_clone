...
export function NotebookSettingsDialog({
  ...
  const [localSettings, setLocalSettings] = useState<NotebookSettings>(
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-[var(--bg-secondary)] border-[rgba(255,255,255,0.1)]">
        <DialogHeader>
          <DialogTitle className="text-[var(--text-primary)] flex items-center gap-2">
            Notebook Settings
            {localSettings.persona?.enabled && (
              <Badge className="bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] border-0">
                {localSettings.persona.name || 'Custom Persona'}
              </Badge>
            )}
          </DialogTitle>
          <DialogDescription className="text-[var(--text-secondary)]">
            Customize how AI responds in "{notebookName}". These settings apply to all
            chat, study materials, and creative outputs.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="persona" className="mt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {Object.entries(PERSONA_PRESETS).map(([key, preset]) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-lg ${preset.bgColor} flex items-center justify-center`}>
              ...
              <div className="space-y-3 pt-2">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 rounded-lg bg-[var(--bg-tertiary)] border border-[rgba(255,255,255,0.1)] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:border-[var(--accent-primary)] focus:outline-none"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className="bg-[var(--bg-tertiary)] border-[rgba(255,255,255,0.1)] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:border-[var(--accent-primary)] resize-none"
                  />
                  <p className="text-xs text-[var(--text-tertiary)]">
          ...
          <TabsContent value="preferences" className="mt-4 space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                <SelectTrigger className="bg-[var(--bg-tertiary)] border-[rgba(255,255,255,0.1)] text-[var(--text-primary)]">
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="flex items-center space-x-3 pt-2">
              <Checkbox
                ...
                className="border-[rgba(255,255,255,0.2)] data-[state=checked]:bg-[var(--accent-primary)] data-[state=checked]:border-[var(--accent-primary)]"
              />
        ...
        <DialogFooter className="mt-6 gap-2">
          <Button
            ...
            className="border-[rgba(255,255,255,0.1)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]"
          >
            Cancel
          </Button>
          <Button
