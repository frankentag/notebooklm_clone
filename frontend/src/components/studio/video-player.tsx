  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {video.video_url ? (
        ...
        <div className="mb-6 p-4 rounded-xl bg-gradient-to-br from-purple-500/5 to-pink-500/5 border border-purple-500/20">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-lg bg-purple-500/20 flex items-center justify-center">
              <FileText className="h-5 w-5 text-purple-400" />
            </div>
            <div>
              <p className="text-sm font-medium text-[var(--text-primary)]">Video Prompt Generated</p>
      ...
      <div className="flex-1 min-h-0">
        ...
        {showScript && video.script && (
          <ScrollArea className="flex-1 h-64 rounded-xl border border-[rgba(255,255,255,0.1)] bg-[var(--bg-tertiary)]">
            <div className="p-4">
