...
export const VIDEO_STYLES = {
  documentary: {
    ...
    promptStyle: 'cinematic documentary footage, professional cinematography, dramatic lighting, smooth camera movements, 4K quality',
  ...
  explainer: {
    ...
    duration: 5 as const,
    promptStyle: 'educational visualization, clean modern graphics, infographic style, smooth animations, professional presentation',
  ...
  presentation: {
    ...
    duration: 5 as const,
    promptStyle: 'professional business presentation, clean corporate aesthetic, modern office environment, polished visuals',
